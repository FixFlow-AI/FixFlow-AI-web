  ...
  return (
    <div className="glass-card rounded-[28px] p-6">
      ...
      <div className="mt-5 space-y-3">
        ...
        <div key={feature.title} className="surface-frame flex items-center justify-between rounded-2xl border border-border bg-background/35 px-4 py-3">
      ...
      <div className="surface-frame rounded-2xl border border-border bg-background/35 px-4 py-6 text-sm text-muted-foreground">
