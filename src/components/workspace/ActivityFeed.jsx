    ...
    <div className="glass-card rounded-[28px] p-6">
      ...
      <div className="mt-5 space-y-4">
        {events.length ? events.map((event) => (
          <div key={event.id} className="rounded-2xl border border-border bg-transparent p-4 text-sm transition-colors hover:bg-background/25 focus-within:bg-background/25">
