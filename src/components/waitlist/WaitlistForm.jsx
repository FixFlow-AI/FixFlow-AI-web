...
function WaitlistForm() {
  ...
  const validate = () => {
    ...
    if (!trimmedName) {
      ...
      newErrors.username = 'Name must be 80 characters or less'
    }
  ...
  const handleChange = (e) => {
    ...
    // Clear submit result when user starts editing
    if (submitResult) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSubmitResult({
        type: 'success',
        message: data.message || 'Thank you for joining the Fix Flow AI waitlist. We will keep you updated.',
      })

      // Reset form on success (but only if it's a new signup, not duplicate)
  ...
  return (
    <section id="waitlist-form" className="py-24 sm:py-32">
      <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <motion.div
            ...
            className="landing-panel-strong rounded-2xl p-8 sm:p-10"
          >
            <form onSubmit={handleSubmit} noValidate className="space-y-6">
              ...
              <div>
                ...
                />
                {errors.username && (
                  <p id="username-error" className="mt-1.5 text-sm text-destructive flex items-center gap-1">
              ...
              <div>
                ...
                {errors.role && (
                  <p id="role-error" className="mt-1.5 text-sm text-destructive flex items-center gap-1">
                    <AlertCircle className="h-3.5 w-3.5" />
                    {errors.role}
                  </p>
                )}
              ...
              <div>
                ...
                <div className="flex justify-between mt-1.5">
                  {errors.comment ? (
                    <p id="comment-error" className="text-sm text-destructive flex items-center gap-1">
                      <AlertCircle className="h-3.5 w-3.5" />
                      {errors.comment}
                    </p>
                  ) : (
