        ...
        >
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              <div key={tip} className="rounded-2xl border border-border bg-transparent px-4 py-3 text-sm text-muted-foreground transition-colors hover:bg-background/35 focus-within:bg-background/35">
