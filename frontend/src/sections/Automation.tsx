    ...
    <section className="automation section-shell" id="automation">
      ...
      <div className="automation-table">
        ...
        {automationRows.map((row, index) => (
          ...
          >
            <span className="automation-work"><small>0{index + 1}</small><strong>{row.work}</strong></span>
      ...
      >
        ...
        <span className="compare-arrow"><ArrowRight aria-hidden="true" size={19} /></span>
        <div>
          <span className="comparison-label"><Sparkles aria-hidden="true" size={14} /> FixFlowAI</span>
          <p>{active.automation}</p>
        </div>
        <span className="compare-arrow"><ArrowRight aria-hidden="true" size={19} /></span>
        <div>
          <span className="comparison-label"><Check aria-hidden="true" size={14} /> Your control</span>
          <p>{active.control}</p>
        </div>
      </motion.div>
    </section>
