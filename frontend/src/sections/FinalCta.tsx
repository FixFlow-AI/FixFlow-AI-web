    ...
    <section className="final-cta" id="early-access">
      <div className="section-shell final-cta-grid">
        <div className="final-cta-copy">
          <RevealText className="final-cta-title">Start with a brief. Leave with a working agreement.</RevealText>
          <p>
            Join the early-access group for your role. We will use your onboarding path to shape
            the workflows that matter before launch.
          </p>
        </div>

        <div className="access-panel">
          <div className="role-selector" role="radiogroup" aria-label="Choose your role">
            {audiences.map((item) => (
              <button
          ...
          <small className="access-note">Product updates only. No marketplace spam.</small>
        </div>
      </div>
    </section>
  )
