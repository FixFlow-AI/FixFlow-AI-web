        ...
        <div className="bg-white border border-[#D9E0E8] rounded-lg p-8 shadow-sm">
          <div className="mb-8">
            ...
            <p className="text-slate-500 text-sm mt-2">
              Create an account to structure project briefs, link proof, and
              fund milestones.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {["client", "freelancer", "agency", "developer"].map((r) => {
          ...
          <div className="mt-8 pt-6 border-t border-[#D9E0E8] flex items-center justify-between text-xs text-slate-500">
            <span className="flex items-center gap-1.5 font-medium text-slate-400">
              <ShieldCheck size={14} className="text-emerald-500" /> Complies
              with GDPR
            </span>
            <span>
              Registered?{" "}
