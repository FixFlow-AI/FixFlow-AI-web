      ...
      <div className="section-shell">
        ...
        <div className="trust-layout">
          <div className="trust-statement">
            ...
            <h3>Confidence stays inspectable from requirement to reputation.</h3>
            <p>
              A rating summarizes an opinion. An evidence trail preserves what was requested,
              what was proven, what was agreed, and what was accepted.
            </p>
          ...
          <ol className="trust-timeline">
            {trustEvents.map(([label, description], index) => (
              <li className={activeIndex === index ? 'is-active' : ''} key={label}>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="trust-event-mark"><Check aria-hidden="true" size={13} /></span>
                  <strong>{label}</strong>
